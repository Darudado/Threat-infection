...
import data.scripts.shipsystems.ThreatMineStrikeStats;
import java.awt.Color;
import java.util.List;
import org.lwjgl.util.vector.Vector2f;

public class ThreatStrikeStats
...
implements MineStrikeStatsAIInfoProvider {
    ...
    public void spawnMine(ShipAPI source, Vector2f mineLoc) {
        ...
        MissileAPI mine = (MissileAPI)engine.spawnProjectile(source, (WeaponAPI)null, "minelayer4", currLoc, (float)Math.random() * 360.0f, (Vector2f)null);
        if (source != null) {
        ...
        return new BaseEveryFrameCombatPlugin(){
            ...
            public void advance(float amount, List<InputEventAPI> events) {
                if (!Global.getCombatEngine().isPaused()) {
                    ...
                    Color c = ThreatMineStrikeStats.JITTER_UNDER_COLOR;
    ...
    public float getMineRange(ShipAPI ship) {
        return ThreatStrikeStats.getRange(ship);
    }
}
